 ...
 */
final class Version20240511121536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, duration INT NOT NULL, cost INT NOT NULL, PRIMARY KEY(id))');
